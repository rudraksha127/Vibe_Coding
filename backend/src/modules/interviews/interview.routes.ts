...
interviewRouter.post(
  "/:id/questions",
  validate({ params: interviewParamsSchema, body: generateQuestionBodySchema }),
  interviewController.generateQuestion
);
interviewRouter.post(
  "/:id/questions/:questionId/answers",
  validate({ params: answerParamsSchema, body: submitAnswerBodySchema }),
  interviewController.submitAnswer
);
interviewRouter.post(
  "/:id/complete",
  validate({ params: interviewParamsSchema }),
  interviewController.completeInterviewSession
);
