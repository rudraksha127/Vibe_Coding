...
export const experienceLevels = ["fresh_graduate", "junior", "mid", "senior", "staff", "principal"] as const;
export const dressCodePreferences = ["business_formal", "business_casual", "smart_casual"] as const;
